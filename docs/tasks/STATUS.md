...
| --- | --- | --- | --- | --- | --- |
| [TASK-005](TASK-005-state-grounded-trade-responses.md) | Ready | Implementer | Unassigned | None | `src/npc/trader_playtest.py`, `tests/test_trader_playtest.py`, `README.md`, `docs/{requirements,architecture,decisions}.md` |
