...
| --- | --- | --- | --- | --- | --- |
| [TASK-001](TASK-001-yaml-authoritative-beast-proof.md) | Ready | Implementer | Unassigned | None | `src/npc/`, `tests/`, `actors/beast.yaml`, `scenarios/`, `README.md`, `docs/requirements.md`, `docs/architecture.md` |
