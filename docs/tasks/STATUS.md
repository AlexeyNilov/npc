...
| --- | --- | --- | --- | --- | --- |
| [TASK-002](TASK-002-record-canonical-observations.md) | Ready | Implementer | Unassigned | None | `src/npc/experiments/fox_causal_turn.py`, `tests/test_fox_causal_turn.py`, `scenarios/fox_causal_turn.yaml`, `docs/architecture.md` |
