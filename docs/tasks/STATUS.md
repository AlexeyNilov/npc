...
| --- | --- | --- | --- | --- | --- |
| [TASK-002](TASK-002-add-authoritative-identity-capability.md) | Ready | Implementer | Unassigned | TASK-001 | `src/npc/trader_playtest.py`, `tests/test_trader_playtest.py`, `docs/requirements.md`, `docs/architecture.md` |
