...
| --- | --- | --- | --- | --- | --- |
| [TASK-001](TASK-001-autonomous-clearing-session.md) | Ready | Implementer | Unassigned | None | Scenario-local runtime, terminal sample, tests, and entry-point/current-design docs |
