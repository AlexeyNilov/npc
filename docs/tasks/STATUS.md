...
| --- | --- | --- | --- | --- | --- |
| [TASK-001](TASK-001-intent-shaped-trader-offers.md) | Ready | Implementer | Unassigned | None | `actors/`, `scenarios/`, `src/npc/`, `tests/`, `docs/evidence/`, `docs/requirements.md`, `docs/architecture.md` |
