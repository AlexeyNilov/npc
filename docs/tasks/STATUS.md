...
| --- | --- | --- | --- | --- | --- |
| [TASK-004](TASK-004-authoritative-conversation-contract.md) | Ready | Implementer | Unassigned | None | `src/npc/trader_playtest.py`, `tests/test_trader_playtest.py`, `README.md`, `docs/{requirements,architecture,decisions}.md` |
